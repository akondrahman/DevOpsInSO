...
naa_file_name <- "/Users/akond/Documents/AkondOneDrive/OneDrive/StackOverflowProject/data/only.title.naa.corp.txt"
...
aa_file_name <- "/Users/akond/Documents/AkondOneDrive/OneDrive/StackOverflowProject/data/only.title.aa.corp.txt"
id_in_all_content <- all_posts_data$Id
